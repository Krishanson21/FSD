...
function Imagemanipulation() {
    ...
    const [innerBackgroundColor, setInnerBackgroundColor] = useState('palegoldenrod'); // State for inner background color
    ...
    // Function to change the background color of the inner div
    const changeInnerBackground = () => {
        const nextIndex = (colorIndex + 1) % colors.length;
        setInnerBackgroundColor(colors[nextIndex]);
    ...
    return (
        <div style={{
            ...
            paddingRight: '20px',
            paddingTop: '100px',
            backgroundColor: 'white', // Outer background color remains unchanged
        }}>
            <div style={{
                height: '200px',
                width: '200px',
                ...
                backgroundColor: innerBackgroundColor, // Use state for inner background color
            }}>
                <img
            ...
            <div>
                ...
                <button onClick={changeInnerBackground}>Change Inner Background</button> {/* Updated button */}
            </div>
        </div>
    );
}
